...
class BaseDataset(Dataset):
    ...
    def __getitem__(self,index):
        ...
        if self.text_type == 'asr_text':
            text = self.text_tokenizer(self.text_process(row['asr_text']))
        elif self.text_type == 'title':
            text = self.text_tokenizer_2(self.text_process(row['title']))
    ...
    def text_tokenizer_2(self,text,text_2=None, max_length=32):
