...
if __name__ == '__main__':
    # 单模型预测
    checkpoint_file = 'checkpoint/data_new_simnet_17_best_3e-04_without_drop_unsup_all_epoch_12.pth'
    test_data_path_list=['data/test_b/test_b.tfrecords']
    desc_file = 'data/desc.json'
    to_save_file = 'result_simnet_all.json'
    test_dataset = BaseDataset(test_data_path_list, desc_file, text_type='com_text', training=False)
